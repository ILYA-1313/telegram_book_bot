#файл со словарем соответствий команд и запросов
#отображенным текстами.
#(хранение текстов сообщений от бота)
#(хранение текстов на кнопках и отправляемых колбэк запросов)
